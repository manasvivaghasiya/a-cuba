...
export class NavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'Dashboards', icon: 'home', type: 'sub', badgeType: 'success', badgeValue: '3', active: true, children: [
				{ path: '/dashboard/default', title: 'Default', type: 'link' },
				{ path: '/dashboard/ecommerce', title: 'Ecommerce', type: 'link' },
				{ path:'/dashboard/eventList',title:'eventList',type:'link'},
				{ path:'/dashboard/CreateEvents',title:'CreateEvents',type:'link'},
